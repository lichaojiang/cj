...
//child_process
exports.execute=(cmdstr,callback)=>{
    this.cmdstr=cmdstr;
    //let cmdstr = bconst.statspython+" "+ path.join(bconst.exedir, py);+" "+params.start+" "+params.end+" "+params.type+" "+params.machine;
    ...
    exec(cmdstr,function(err,stdout,stderr) {
        if(err){
            ...
            let output = callback(stdout,argv)
